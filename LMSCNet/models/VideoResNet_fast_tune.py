...
from .backbone import VideoResNet
...
class Decoder(nn.Module):
    def __init__(self, ch_lst, de_ch):
        ...
        #self.stem = stem()
        self.lateral3 = Conv3d3x3BNReLU(ch_lst[2],de_ch)
        self.lateral2 = Conv3d3x3BNReLU(ch_lst[1],de_ch)
        self.lateral1 = Conv3d3x3BNReLU(ch_lst[0],de_ch)
        self.layer1 = Conv3d3x3BNReLU(ch_lst[3], de_ch)
        self.layer2 = Conv3d3x3BNReLU(de_ch, de_ch)
        self.layer3 = Conv3d3x3BNReLU(de_ch, de_ch)
        self.layer4 = Conv3d3x3BNReLU(de_ch, de_ch)
        self.layer_5 = nn.Conv3d(in_channels=de_ch,out_channels=20,kernel_size=1,stride=1,padding=0)
