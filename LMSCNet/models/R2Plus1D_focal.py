...
class R2Plus1D_focal(nn.Module):
  ...
  def compute_loss(self, scores, data):
    ...
    criterion_1 = WeightedFocalLoss(alpha=class_weights_bce, gamma=2, device=device)
...
class WeightedFocalLoss(nn.Module):
  def __init__(self, alpha=1, gamma=4, device='cuda'):
